...
public class HeadScreen extends WindowScreen {
    ...
    private void loadHeads() {
        MeteorExecutor.execute(() -> {
            ...
            for (ItemStack head : heads) {
                ...
                equip.action = () -> mc.player.equipStack(EquipmentSlot.HEAD, head.copy());
                t.row();
            }
            set();
    ...
    private ItemStack createHeadStack(String uuid, String value, String name) {
        ...
        tag.put("SkullOwner", createSkullOwnerNbt(uuid, name, value));
    ...
    private static NbtCompound createSkullOwnerNbt(String uuidString, String name, String textureValue) {
        NbtCompound skullOwner = new NbtCompound();

        try {
            if (uuidString != null && !uuidString.isEmpty()) skullOwner.putString("Id", UUID.fromString(uuidString).toString());
